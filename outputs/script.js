...
const TRANSLATIONS = {
  en: {
    ...
    "info.journal.body": "Explore campaign notes, collection inspiration, and soft routines from the GoharsLab studio.",
    "info.about.eyebrow": "About",
    "info.about.title": "Luxury beauty with a natural point of view.",
    "info.about.body": "GoharsLab blends nature, design, and self-expression into products that look beautiful before they ever touch skin.",
    "info.stores.eyebrow": "Stores",
    "info.stores.title": "Future spaces for GoharsLab.",
    ...
    "article.journal.3.body": "How ivory, blush, lavender, sage, and rose gold became the visual language of GoharsLab.",
    ...
    "article.stores.3.body": "GoharsLab begins online, then grows toward selected physical spaces when the brand is ready.",
  ...
  ru: {
    ...
    "info.journal.body": "Читайте заметки кампаний, вдохновение коллекций и мягкие рутины из студии GoharsLab.",
    "info.about.eyebrow": "О нас",
    "info.about.title": "Люксовая красота с природной точкой зрения.",
    "info.about.body": "GoharsLab соединяет природу, дизайн и самовыражение в продуктах, которые выглядят красиво еще до прикосновения к коже.",
    "info.stores.eyebrow": "Магазины",
    "info.stores.title": "Будущие пространства для GoharsLab.",
    ...
    "article.journal.3.body": "Как ivory, blush, lavender, sage и rose gold стали визуальным языком GoharsLab.",
    ...
    "article.stores.3.body": "GoharsLab начинается онлайн, а затем будет расти к избранным физическим пространствам, когда бренд будет готов.",
  ...
  hy: {
    ...
    "info.journal.body": "Բացահայտեք քարոզարշավների նշումները, հավաքածուների ոգեշնչումը և մեղմ ռուտինները GoharsLab ստուդիայից։",
    "info.about.eyebrow": "Մեր մասին",
    "info.about.title": "Լյուքս գեղեցկություն՝ բնական հայացքով։",
    "info.about.body": "GoharsLab-ը միավորում է բնությունը, դիզայնը և ինքնարտահայտումը ապրանքներում, որոնք գեղեցիկ են թվում դեռ մինչև մաշկին դիպչելը։",
    "info.stores.eyebrow": "Խանութներ",
    "info.stores.title": "Ապագա տարածքներ GoharsLab-ի համար։",
    ...
    "article.journal.3.body": "Ինչպես ivory, blush, lavender, sage և rose gold երանգները դարձան GoharsLab-ի տեսողական լեզուն։",
    ...
    "article.stores.3.body": "GoharsLab-ը սկսվում է առցանց, հետո կաճի դեպի ընտրված ֆիզիկական տարածքներ, երբ բրենդը պատրաստ լինի։",
...
function productVisual(item) {
  ...
  return `
    <div class="visual-set product-preview ${visualClass(item.collection)}" style="--product-tone:${item.tone}">
      ...
      <span class="preview-brand">GoharsLab</span>
